...
export const PROGRAMS = [
  {
    ...
    weatherSummary: "Maritime climate: cool summers (~15–20°C), mild winters; rain common year-round — layers + waterproofs.",
    distanceFromDelhiKm: 7160,
    typicalFlightHrs: "~9.5–12h typical (often one stop via hub).",
    livingCostTier: "High (capital city, tight rental market).",
    postStudyWorkSummary: "Ireland: up to 24 months stay for eligible non-EU grads (verify current Stamp 2G rules).",
    deadlines: [
  ...
  },
  {
    ...
    weatherSummary: "Same as Dublin: mild, damp, windy; winter ~2–8°C; summer rarely hot.",
    distanceFromDelhiKm: 7160,
    typicalFlightHrs: "~9.5–12h typical (often one stop).",
    livingCostTier: "High — city-centre campus, student demand for housing.",
    postStudyWorkSummary: "Ireland: eligible graduates may access post-study permission — confirm with official sources.",
    deadlines: [
  ...
  },
  {
    ...
    weatherSummary: "Temperate: milder than London; wet winters; summer ~20°C — umbrella essential.",
    distanceFromDelhiKm: 6720,
    typicalFlightHrs: "~9–11h to London + ~1.5h surface to Bath.",
    livingCostTier: "High — popular student city, limited campus beds.",
    postStudyWorkSummary: "UK: Graduate route may apply for eligible courses — check UKVI and your CAS details.",
    deadlines: [

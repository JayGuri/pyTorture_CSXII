...
export default function StaggeredMenu({
    ...
    (e, link) => {
      ...
      if (link.startsWith("#")) {
        ...
        if (location.pathname !== "/for-you") {
          navigate(`/for-you${link}`);
          window.setTimeout(() => scrollToSection(link), 200);
        } else {
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="For you navigation">
        <button
          ref={toggleBtnRef}
          className="sm-toggle"

...
const Mission = () => {
  return (
    <section id="mission" className="bg-fateh-paper">
        ...
        <div className="grid gap-14 lg:grid-cols-12 lg:gap-10">
          ...
          >
            <div className="border-t-2 border-fateh-gold pt-8">
              <p className="text-[0.7rem] font-medium uppercase tracking-[0.22em] text-fateh-gold">Our Mission</p>
          ...
          >
            ...
            <p className="mt-8 max-w-2xl text-[1.06rem] leading-[1.9] text-fateh-muted">
              Provide intellectual opinion on anything related to studying in the UK and Ireland with utmost
              empathy — enabling students, parents and all stakeholders to arrive at a higher level of
              clarity, validate their hypotheses, and make informed decisions. Choosing to study abroad is
              often a once-in-a-lifetime decision. You deserve someone who truly cares.
            </p>

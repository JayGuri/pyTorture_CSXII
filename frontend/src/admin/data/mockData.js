...
export const ANALYTICS_SUMMARY = {
  ...
  leadsHotPercent: 22,
  topQuestions: [
    { q: "What is the total cost including living?", count: 312 },
    { q: "Scholarships for Indian students", count: 276 },
    { q: "Post-study work visa length", count: 241 },
    { q: "Timeline from offer to visa", count: 198 },
    { q: "Part-time work hours allowed", count: 165 },
  ],
  conversionFunnel: [
